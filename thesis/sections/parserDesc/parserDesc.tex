...
As reported in \Cref{tab:combinedgpt52}, \texttt{GPT-5.2} does not improve the ``Single Score'' relative to the strongest previously tested configurations, and the resulting closed gap remains negative. The obtained value is lower than 3 of the \texttt{fzn2nl}-based variants reported in \Cref{tab:combinedFznTemp}, as well as below the 2 best-performing configurations evaluated on the restricted portfolio (\Cref{tab:CombinedSelSolversTop}).
