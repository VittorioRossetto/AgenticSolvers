...
\bibitem{algSelRanking} R. Oentaryo, S. D. Handoko, and H. C. Lau, ``Algorithm Selection via Ranking'', Proceedings of the AAAI Conference on Artificial Intelligence, vol. 29, no. 1, Feb. 2015, doi: https://doi.org/10.1609/aaai.v29i1.9466.
...
\bibitem{simplexintPLP} Szabo, Zsuzsanna \& Kovacs, Marta. ``ON INTERIOR-POINT METHODS AND SIMPLEX METHOD IN LINEAR PROGRAMMING''. Analele Stiintifice ale Universitatii Ovidius Constanta, Seria Matematica. 11. (2003).
\bibitem{HiGHS} ``HiGHS - High-performance parallel linear optimization software'', Highs.dev, 2024. https://highs.dev/
\bibitem{BBAlg} D. R. Morrison, S. H. Jacobson, J. J. Sauppe, and E. C. Sewell, ``Branch-and-bound algorithms: A survey of recent advances in searching, branching, and pruning'', Discrete Optimization, vol. 19, pp. 79-102, Feb. 2016, doi: https://doi.org/10.1016/j.disopt.2016.01.005.
\bibitem{BCAlg} J. Wang and Y. Yang, ``Branch-cut algorithm with fast search ability for the shortest branch-cuts based on modified GA'', Journal of Modern Optics, vol. 66, no. 5, pp. 473-485, Nov. 2018, doi: https://doi.org/10.1080/09500340.2018.1548663.
...
\bibitem{cbc} ``Cbc'', GitHub, May 24, 2022. https://github.com/coin-or/Cbc
\bibitem{chuffed} ``Chuffed, a lazy clause generation solver'', GitHub, Dec. 07, 2023. https://github.com/chuffed/chuffed
%%%%%%%%%%% Parser %%%%%%%%%%%
\bibitem{fzn2nl} Vittorio Rossetto, ``GitHub - VittorioRossetto/fzn2nl'', GitHub, 2025. https://github.com/VittorioRossetto/fzn2nl (accessed Feb. 06, 2026).
...
\bibitem{gpt52} ``Introducing GPT-5.2'', Openai.com, Dec. 11, 2025. https://openai.com/index/introducing-gpt-5-2/
\bibitem{GDPval} T. Patwardhan et al., ``GDPval: Evaluating AI Model Performance on Real-World Economically Valuable Tasks'', arXiv (Cornell University), Oct. 2025, doi: https://doi.org/10.48550/arxiv.2510.04374.
\bibitem{chatGPT} OpenAI, ``ChatGPT'', ChatGPT, 2025. https://chatgpt.com/
\bibitem{gpt52Limits} ``GPT-5.2 in ChatGPT  OpenAI Help Center,'' OpenAI Help Center, 2026. https://help.openai.com/en/articles/11909943-gpt-52-in-chatgpt\#h\_1fadb43e65 (accessed Feb. 11, 2026).
\bibitem{LLMapprehension} P. Sychev, A. Goncharov, D. Vyazhev, E. Khalafyan, and A. Zaytsev, ``When an LLM is apprehensive about its answers -- and when its uncertainty is justified'', arXiv (Cornell University), Mar. 2025, doi: https://doi.org/10.48550/arxiv.2503.01688.
\bibitem{IBM} ibm, ``IBM - United Kingdom'', Ibm.com, Apr. 26, 2019. https://www.ibm.com/
\end{thebibliography}
